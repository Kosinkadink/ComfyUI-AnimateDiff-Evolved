...
class VanillaTemporalModule(nn.Module):
    ...
    def set_scale(self, multiplier: Union[float, Tensor, None], per_block_list: Union[list[PerBlock], None]=None):
        self.temporal_transformer.set_scale(multiplier)
